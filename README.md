...
La página consta de forma general de varios elementos anidados:
tenemos un header en el body que tiene id y contiene una imagen, tambien contiene la barra de navegación fija que a su vez contiene logo, tres elementos de menú y un botón.
Posteriormente tenemos una sección con 3 elementos  en lista y otro botón correspondiente al log-in
A continuación tenemos una sección con elementos de lista también con tres filas de texto y una gran imagen lateral.
En el footer tenemos 3 columnas que contienen 11 elementos de texto y por ultimo tenemos 2 imagenes que refieren que la descarga de lyft esta disponible para las tiendas google play y microsoft.
